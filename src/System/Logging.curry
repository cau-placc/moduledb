...
showLogLine (ct,pat,ip) =
  ...
  -- generated by CurryPP (put here to support VisualCode editing)
   ((Data.Format.showString ('s') (Just "-") (Just 20) (Nothing) ( calendarTimeToString ct)) ++ ": " ++ (Data.Format.showString ('s') (Just "-") (Just 35) (Just 35) ( show pat)) ++ " (" ++ (Data.Format.showString ('s') (Nothing) (Nothing) (Nothing) ( ip)) ++ ")")
