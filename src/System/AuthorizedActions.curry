...
--- entity is allowed.
studyProgramOperationAllowed :: AccessType StudyProgram -> UserSessionInfo
                             -> IO AccessResult
studyProgramOperationAllowed at sinfo = case at of
...
categoryOperationAllowed :: AccessType Category -> UserSessionInfo
                         -> IO AccessResult
categoryOperationAllowed at sinfo = case at of
  ListEntities -> return AccessGranted
  ShowEntity _ -> return AccessGranted
  _            -> checkAdmin sinfo
...
--- entity is allowed.
masterCoreAreaOperationAllowed :: AccessType MasterCoreArea -> UserSessionInfo
                               -> IO AccessResult
masterCoreAreaOperationAllowed at sinfo = case at of
  ListEntities -> return AccessGranted
  ShowEntity _ -> return AccessGranted
  _            -> checkAdmin sinfo
...
--- entity is allowed.
modDataOperationAllowed :: AccessType ModData -> UserSessionInfo
                        -> IO AccessResult
modDataOperationAllowed at sinfo = case at of
  ListEntities    -> return AccessGranted
...
--- entity is allowed.
modDescrOperationAllowed :: AccessType ModDescr -> UserSessionInfo
                         -> IO AccessResult
modDescrOperationAllowed at _ = case at of
  ListEntities   -> return AccessGranted
...
--- entity is allowed.
modInstOperationAllowed :: AccessType ModInst -> UserSessionInfo
                        -> IO AccessResult
modInstOperationAllowed at _ = case at of
  ListEntities   -> return AccessGranted
  ShowEntity _   -> return AccessGranted
  NewEntity      -> return AccessGranted
  DeleteEntity _ -> return AccessGranted
...
--- entity is allowed.
advisorStudyProgramOperationAllowed :: AccessType AdvisorStudyProgram
                                    -> UserSessionInfo -> IO AccessResult
advisorStudyProgramOperationAllowed at sinfo = case at of
  ListEntities     -> return AccessGranted
...
masterProgramOperationAllowed :: AccessType MasterProgram -> UserSessionInfo
                              -> IO AccessResult
masterProgramOperationAllowed at sinfo = case at of
  ListEntities    -> return AccessGranted
  NewEntity       -> isLoggedIn
  ShowEntity _    -> return AccessGranted
  DeleteEntity _  -> checkAdmin sinfo
...
--- entity is allowed.
masterProgInfoOperationAllowed :: AccessType MasterProgInfo -> UserSessionInfo
                               -> IO AccessResult
masterProgInfoOperationAllowed at sinfo = case at of
  ListEntities   -> return AccessGranted
  NewEntity      -> isLoggedIn
  ShowEntity   _ -> return AccessGranted
  DeleteEntity _ -> checkAdmin sinfo
...
--- entity is allowed.
univisInfoOperationAllowed :: AccessType UnivisInfo -> UserSessionInfo
                           -> IO AccessResult
univisInfoOperationAllowed _ = checkAdmin

--- Checks whether the application of an operation to a Student
--- entity is allowed.
studentOperationAllowed :: AccessType Student -> UserSessionInfo
                        -> IO AccessResult
studentOperationAllowed at sinfo = case at of
  NewEntity -> return AccessGranted
  _         -> checkAdmin sinfo

--- Checks whether the application of an operation to a StudentCourse
--- entity is allowed.
studentCourseOperationAllowed :: AccessType StudentCourse -> UserSessionInfo
                              -> IO AccessResult
