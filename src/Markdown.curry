------------------------------------------------------------------------------
--- IMPORTANT NOTE:
--- In contrast to Text.Markdown of package markdown,
--- this older version suppors the inclusion of HTML structures
--- inside markdown texts. This was used at some time in MDB
--- but causes some trouble. Therefore, this module is included
